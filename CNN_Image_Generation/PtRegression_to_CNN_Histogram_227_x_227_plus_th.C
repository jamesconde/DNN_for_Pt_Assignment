...
void PtRegression_to_CNN_Histogram_227_x_227_plus_th()
{
	//Source data
	...
	int numEvents = 10;//User set number of events
	cout<<">>>>>>>>>>>>>>>>>>>>>"<<endl;
        cout<<numEvents<<" events to process..."<<endl;
	
	//pT values file
	TString outFolder = "/storage1/users/eb8/image_size_test/";
	...
	for(Long64_t iEntry = 0; iEntry <numEvents; iEntry++){
		...
		//Save images
                ...
                TString img_name;
                img_name.Form("event%04d.png",int(iEntry));
