...
#include <fstream>
#include <time.h>
void PtRegression_to_CNN_Histogram_227_x_227_plus_th_100th_events()
{
	//Source data
	...
	int numEvents = 100000;//User set number of events
	cout<<">>>>>>>>>>>>>>>>>>>>>"<<endl;
        cout<<numEvents<<" events to process..."<<endl;
	
	//pT values file
	//TString outFolder = "/storage1/users/eb8/time_test/";
	TString outFolder = "/storage1/users/eb8/CNN_Images_227_227_plus_th_100th_events_Dec_19_2017/";
